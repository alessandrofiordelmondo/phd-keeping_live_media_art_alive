...
\usepackage[a-1b]{pdfx} % Creates a PDF/A-1b compliant file
...
\thesisHeader{University of Udine, Department of Humanities and Cultural Heritage (DIUM)\\Ph.D. Thesis in Art History, Film Studies, Media Studies, and Music}
...
\secondpage{\input{LaTeX-thesis/docs/secondcover}}
...
\input{LaTeX-thesis/custom-symbols}
...
\begin{document}
    \includepdf[pages=1]{LaTeX-thesis/Frontespizio tesi_PON.pdf}
    ...
    \input{LaTeX-thesis/chapters/0-methodology}
    
    \input{LaTeX-thesis/chapters/1-state_of_the_art/1-state_of_the_art}

    \input{LaTeX-thesis/chapters/2-new_conservation_paradigms/2-new_conservation_paradigms}
    
    \input{LaTeX-thesis/chapters/3-mdc_model-reactivation_workflow-instruction_template/3-mdc_model-reactivation_workflow-instruction_template}
    
    \input{LaTeX-thesis/chapters/4-MDC_model_application/4-MDC_model_application}

    % conclusion ---------------
    \input{LaTeX-thesis/chapters/conclusions}

    
    % appendices ---------------
    \begin{appendices}
        \include{LaTeX-thesis/chapters/appendix/a/a-michele_sambin_videoloop}
        \include{LaTeX-thesis/chapters/appendix/b/b-hybrid_reactivation_il_caos_delle_sfere}
        \include{LaTeX-thesis/chapters/appendix/c/c-the_score_in_live_electronics_music}
        \include{LaTeX-thesis/chapters/appendix/d/d-sustainability_and_longevity_of_NIMEs}
        \include{LaTeX-thesis/chapters/appendix/e-web_review_tables}
        \include{LaTeX-thesis/chapters/appendix/f-table_of_organisations}
    \end{appendices}
